...
async function main(): Promise<void> {
  ...
  const records = companies.flatMap((company) => company.ownershipPeriods.map((owner) => ({
    ...
    currentAttributedFundName: owner.attributedFundName,
    currentAttributionConfidence: owner.attributionConfidence,
    currentAttributionRationale: owner.attributionRationale,
