/** Exclusive raw retrieval of existing task140 attribution sources; no database access. */
...
const historical=JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0140-environmental-360-solutions/attempt-1/source-verification.json","utf8"));
const ids=["closing","bureau","shareholders","blackrock","us-entry","about"];
...
sources.push({id:"home",url:"https://e360s.ca/",file:"home.html",historicalSha256:null,historicalHttpStatus:null});
