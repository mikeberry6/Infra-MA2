/** Exclusive raw retrieval of existing task141 attribution sources; no database access. */
...
const historical=JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0141-eolian/attempt-1/source-verification.json","utf8"));
const ids=["portfolio","home","leadership","acquisition","flint","able-grid","blackrock"];
