/** Exclusive raw retrieval of existing task142 attribution sources; no database access. */
...
const historical=JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0142-excelsior-u-s-solar-and-storage-portfolio/attempt-1/source-verification.json","utf8"));
const ids=["keybanc","buyer","seller","blackrock"];
...
sources.push({id:"natural-power",url:"https://www.naturalpower.com/us/news/news-post/natural-power-supports-blackrocks-portfolio-acquisition-from-excelsior-energy-capital",file:"natural-power.html",historicalSha256:null,historicalHttpStatus:null},{id:"home",url:"https://excelsiorcapital.com/",file:"home.html",historicalSha256:null,historicalHttpStatus:null});
