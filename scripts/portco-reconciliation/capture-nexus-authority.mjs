/** Exclusive raw retrieval of existing task127 attribution sources; no database access. */
...
const historical = JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0127-nexus-water-group/attempt-1/source-verification.json", "utf8"));
const sources = [
  { id: "cpuc", index: 0, file: "cpuc-structure.pdf" },
  { id: "launch", index: 1, file: "launch.html" },
  { id: "tennessee", index: 2, file: "tennessee-testimony.pdf" },
  { id: "meag", index: 4, file: "meag.html" },
