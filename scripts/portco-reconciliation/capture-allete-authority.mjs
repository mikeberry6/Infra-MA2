/** Exclusive raw retrieval of existing task133 attribution sources; no database access. */
...
const historical = JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0133-allete-inc/attempt-1/source-verification.json", "utf8"));
const sources = [
  { id: "closing", index: 0, file: "closing-8k.html" },
  { id: "proxy", index: 1, file: "proxy.html" },
  { id: "testimony", index: 2, file: "testimony.pdf" },
  { id: "blackrock", index: 3, file: "blackrock.html" },
