/** Exclusive raw retrieval of existing task126 attribution evidence; no data writes. */
...
const historical = JSON.parse(await readFile("audits/portco-reconciliation/2026-08-03/execution-v1/tasks/0126-mosaic-forest-management/attempt-1/source-verification.json", "utf8"));
const sources = [
  { id: "statutory-2026", index: 1, file: "statutory-2026.pdf" },
  { id: "bci-program", index: 2, file: "bci-program-2025.pdf" },
  { id: "psp", index: 3, file: "psp.html" },
  { id: "launch", index: 4, file: "launch.html" },
