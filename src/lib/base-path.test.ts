...
describe("callback URL validation", () => {
  ...
  it("accepts application paths and rejects external redirects", async () => {
    ...
    expect(
      normalizeNextAuthRedirect("https://attacker.example/phish", "https://infrasight.example"),
    ).toBe("https://infrasight.example/Infra-MA2/");
  });
});
