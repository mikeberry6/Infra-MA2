export default function LoginLoading() {
  return (
    <div role="status" aria-label="Loading login" aria-busy="true" className="mx-auto flex min-h-[calc(100vh-10rem)] max-w-md animate-pulse items-center px-4 py-12">
      <span className="sr-only">Loading login…</span>
      <div aria-hidden="true" className="w-full rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] p-6">
