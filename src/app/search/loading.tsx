export default function SearchLoading() {
  return (
    <div role="status" aria-label="Loading search" aria-busy="true" className="mx-auto max-w-[900px] animate-pulse px-4 py-8 sm:px-6 sm:py-10">
      <span className="sr-only">Loading search…</span>
      <div aria-hidden="true" className="h-2 w-64 rounded bg-[var(--bg-hover)]" />
