export default function NewsLoading() {
  return (
    <div role="status" aria-label="Loading news" aria-busy="true" className="mx-auto max-w-[1280px] animate-pulse px-4 py-6 sm:px-6">
      <span className="sr-only">Loading news…</span>
      <div aria-hidden="true" className="h-48 rounded-lg bg-[var(--bg-hover)]" />
