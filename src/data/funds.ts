...
export const funds: Fund[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    regions: ["Europe"],
    portfolioCompanies: ["Belfast City Airport", "DNS:NET", "ESVAGT", "Global Cloud Xchange (FLAG)", "Future Biogas", "Herambiente", "Infinis", "Ionisos", "Joulz", "Oystercatcher", "SRL Traffic Systems", "Tampnet", "TCR"],
  },
  {
    id: "FUND-001b",
    managerName: "3i Group",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    regions: ["Global"],
    portfolioCompanies: ["Athena Renewable Energy", "Oman Green Hydrogen Project", "Orygen", "Stride Climate Investments", "Terra Solar", "Valia Energía"],
  },
  {
    id: "FUND-003b",
    managerName: "Actis",
    ...
    portfolioCompanies: ["Argo Energy", "BluPine Energy", "Bridgin Power", "Catalyze", "Levanta Renewables", "MTerra Solar", "Nozomi Energy", "Rezolv Energy", "Yellow Door Energy"],
  },
  {
    id: "FUND-003c",
    managerName: "Actis",
    ...
    regions: ["Global"],
    portfolioCompanies: ["800 Super Holdings", "Barghest Building Performance (bbp)", "BGPL", "Chayora", "Colombian Toll Road Portfolio", "Emicool", "HRZ Transmissoras", "NXT Infra", "Skyline", "Uludag Energy", "ConnectisTower", "Epoch Digital", "NextStream", "Rack Centre", "Swiftnet", "TERRANOVA"],
  },
  {
    id: "FUND-003d",
    managerName: "Actis",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    regions: ["Global"],
    portfolioCompanies: [
      "Aligned Data Centers", "AlphaGen", "Anglian Water Group", "Arevon Energy",
      "Cellnex Telecom", "Cube Highways", "EdgeConneX", "EdgePoint Infrastructure",
      "Equis Development", "FiberCop", "Gatwick Airport", "GLP", "GMR Airports",
      "Greenko Energy Holdings", "Jio Digital Fiber", "Kemble Water Holdings (Thames Water)",
      "Landmark Dividend LLC", "Malaysia Airports Holdings Berhad (MAHB)", "NetCo SRL",
      "Open Fiber", "Queensland Motorways", "ReNew Power", "Scotia Gas Networks (SGN)",
      "Sempra Infrastructure Partners", "Sumatra Toll Roads", "Sydney Airport",
      "Terna Energy", "Trans-Java Toll Roads", "Transgrid",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    portfolioCompanies: [
      ...
      "Chicago Parking Meters", "Colchester Garrison", "Dargikowo and Karlino (ENERTRAG)",
      "Delgaz Grid", "Elenia", "Floene (formerly GGND)", "Fuella AS",
      "Gas Connect Austria (GCA)", "Gassled", "GasNet", "He Dreiht",
      "IndInfravit Trust", "Kyon Energy Storage Portfolio", "Nedgia", "NET4GAS",
      "NeuConnect", "NÖGIG", "Northrail", "Northstar", "oeGIG", "Porterbrook",
