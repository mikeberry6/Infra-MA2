...
export const funds: Fund[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    size: "~£3.4 Billion (Market Cap) / ~£4.1 Billion (Portfolio Value)",
    sizeUsdMm: 4300,
    vintage: "2007",
    ...
    regions: ["Europe"],
    portfolioCompanies: ["DNS:NET", "ESVAGT", "FLAG (formerly Global Cloud Xchange)", "Future Biogas", "Infinis", "Ionisos", "Joulz", "SRL Traffic Systems", "Tampnet", "TCR"],
  },
  {
    id: "FUND-001b",
    managerName: "3i Group",
    ...
    portfolioCompanies: ["Amwaste", "EC Waste", "Regional Rail"],
  },
  {
    id: "FUND-001c",
    managerName: "3i Group",
    ...
    size: "~$860 Million (~£700 Million commitment)",
    sizeUsdMm: 860,
    vintage: "2017",
    strategies: ["Core"],
    structure: "Closed-End",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    size: "$9 Billion (Total project pipeline target)",
    sizeUsdMm: null,
    vintage: "2024",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    regions: ["Latin America", "Asia-Pacific", "Middle East & Africa", "Europe"],
    portfolioCompanies: ["Terra Solar"],
  },
  {
    id: "FUND-003b",
    managerName: "Actis",
    ...
    sectors: ["Renewables / Energy Transition", "Power Generation"],
    regions: ["Latin America", "Asia-Pacific", "Middle East & Africa", "Europe"],
    portfolioCompanies: ["Argo Energy", "BluPine Energy", "Bridgin Power", "Catalyze", "Levanta Renewables", "Nozomi Energy", "Orygen", "Rezolv Energy", "Serena Energy", "Valia Energía", "Yellow Door Energy"],
  },
  {
    id: "FUND-003c",
    managerName: "Actis",
    ...
    regions: ["Latin America", "Asia-Pacific", "Middle East & Africa", "Europe"],
    portfolioCompanies: ["800 Super Holdings", "Barghest Building Performance (bbp)", "Colombian Toll Road Portfolio", "ConnectisTower", "NextStream", "Skyline", "Swiftnet"],
  },
  {
    id: "FUND-003d",
    managerName: "Actis",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    regions: ["Global"],
    portfolioCompanies: [
      "Arevon Energy", "Cellnex Telecom", "Cube Highways", "Equis Development",
      "FiberCop", "Gatwick Airport",
      "Sempra Infrastructure Partners", "Transgrid",
      "Vantage Data Centers APAC", "VTG", "WestConnex",
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    portfolioCompanies: [
      ...
      "Elenia", "Fuella AS", "Gassled", "He Dreiht",
      "NET4GAS", "NeuConnect", "oeGIG", "Porterbrook",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    size: "~£2.3 Billion (Market Cap) / >£3.0 Billion (GAV)",
    sizeUsdMm: 2900,
    vintage: "2006",
    strategies: ["Core", "Core-Plus"],
    structure: "Closed-End",
  ...
  },
  {
    ...
    size: "~€930 Million (Targeting €3.0–€5.0 Billion)",
    sizeUsdMm: 1100,
    vintage: "2020",
  ...
  },
  {
    ...
    sectors: ["Renewables / Energy Transition", "Digital Infrastructure", "Transportation", "Social Infrastructure"],
    regions: ["Europe", "North America"],
    portfolioCompanies: ["Aquavista", "ERR (European Rail Rent)", "Pulsant", "Swiftair", "Lake State Railway Company (LSRC)", "Empire Access"],
  },
  {
    id: "FUND-008c",
    managerName: "Antin Infrastructure Partners",
    ...
    strategies: ["Growth"],
    structure: "Closed-End",
    sectors: ["Transportation", "Renewables / Energy Transition", "Waste / Environmental Services", "Digital Infrastructure"],
    regions: ["Europe", "North America"],
    portfolioCompanies: ["Enviro / Michelin Tire Recycling JV", "GTL Leasing", "Matawan", "PearlX", "Power Dot", "RAW Charging", "SNRG"],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    portfolioCompanies: [
      ...
      "SkyNRG", "Stockholm Exergi", "Interparking (incl. Saba)",
      "Brisa", "Brussels Airport",
      "Nexera", "HICL UK Seed Portfolio",
    ],
  },
  {
    id: "FUND-009b",
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    portfolioCompanies: ["GFL Environmental Services", "Modern Aviation", "Stack Infrastructure"],
  },
  {
    id: "FUND-010b",
    managerName: "Apollo Global Management",
    ...
    regions: ["North America", "Europe"],
    portfolioCompanies: ["Energos Infrastructure", "Johnson Controls (OpenBlue JV)", "Primafrio", "US Wind"],
  },
  {
    id: "FUND-010c",
    managerName: "Apollo Global Management",
    ...
    sectors: ["Renewables / Energy Transition", "Transportation"],
    regions: ["North America", "Europe"],
    portfolioCompanies: ["Purmo Group", "TotalEnergies Texas Solar & BESS Portfolio"],
  },
  {
    id: "FUND-010d",
    managerName: "Apollo Global Management",
    ...
    size: "~$1.0 Billion (NAV, estimated)",
    sizeUsdMm: 1000,
    vintage: "2023",
    strategies: ["Core", "Core-Plus", "Credit / Debt"],
    structure: "Open-End",
