...
export const deals: Deal[] = [
  ...
  {
    id: "INF-2026-031",
    title: "CIP agrees to acquire Ørsted Onshore Europe 578 MW wind/solar portfolio and pipeline",
    ...
    description:
      "Copenhagen Infrastructure Partners agreed to acquire a 578 MW operating wind and solar portfolio and development pipeline across the UK, Germany, and Spain from Ørsted Onshore Europe.",
    targetDescription:
      "Ørsted Onshore Europe, a 578 MW operating wind and solar portfolio and development pipeline across the UK, Germany, and Spain.",
    sourceName: "CIP",
    sourceUrl: "",
  },
  ...
  {
    id: "INF-2026-032",
    title: "Antin signs definitive agreement to acquire Vigor Marine Group from Lone Star",
    buyer: "Antin Infrastructure Partners",
    ...
    targetDescription:
      "Vigor Marine Group, a critical maritime infrastructure provider operating shipyards and drydocks.",
    sourceName: "Antin",
    sourceUrl: "",
  },
  ...
  {
    id: "INF-2026-033",
    title: "ECP and KKR announce $50B partnership and launch hyperscale data center JV in Texas",
    ...
    description:
      "Energy Capital Partners and KKR announced a $50 billion strategic partnership and launched a joint venture to develop a hyperscale data center campus in Texas.",
    targetDescription:
  ...
  {
    id: "INF-2026-035",
    title: "Schroders Greencoat agrees to acquire 283 MW UK solar portfolio from METLEN",
    buyer: "Schroders Greencoat",
    seller: "METLEN Energy & Metals",
    sector: "Power & ET",
    subsector: "Solar",
    ...
    description:
      "Schroders Greencoat entered an agreement to acquire 283 MW of solar PV assets, both operational and under construction, from METLEN Energy & Metals.",
    targetDescription:
      "A 283 MW portfolio of solar PV assets (operational and under construction) in the UK.",
    sourceName: "Schroders Greencoat",
    sourceUrl: "",
  },
  ...
  {
    id: "INF-2026-036",
    title: "KKR and Singtel enter agreements to acquire controlling 82% stake in STT GDC",
    buyer: "KKR & Singtel",
    seller: "ST Telemedia Global Data Centres",
    sector: "Digital",
    subsector: "Data Centers",
    region: "Asia-Pacific",
    category: "Acquisition (Majority Stake)",
  ...
  // ─── 37. IFM Investors – Mobius Renewables ──────────────
  {
    ...
    targetDescription:
      "Mobius Renewables, a vertically integrated platform for renewable natural gas (RNG) development.",
  ...
  {
    id: "INF-2026-038",
    title: "Igneo acquires Vault Digital Infrastructure US data center platform",
  ...
  {
    id: "INF-2026-040",
    title: "Macquarie agrees to acquire 100% of Energy Assets Group UK utility provider",
    buyer: "Macquarie Asset Management",
    seller: "Energy Assets Group",
    sector: "Utilities",
    subsector: "Utility & Metering Infrastructure",
    region: "Europe",
    category: "Acquisition (Buyout)",
  ...
  {
    id: "INF-2026-042",
    title: "TPG Rise Climate signs agreements to acquire majority stake in Sabre Industries",
