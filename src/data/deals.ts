...
export const deals: Deal[] = [
  ...
  // ─── 78. DESRI – Linea Energy (EnCap) Duffy BESS ───────────
  {
    ...
    date: "2026-02-18T08:00:00Z",
    description:
      "DESRI (D. E. Shaw Renewable Investments) announced the signing of a preferred equity financing for the Duffy Battery Energy Storage System (BESS) project in Matagorda County, Texas, developed by Linea Energy, a portfolio company of EnCap Investments.",
    targetDescription:
      "Duffy BESS, a battery energy storage system project in Matagorda County, Texas, developed by Linea Energy (an EnCap Investments portfolio company).",
    sourceName: "PR Newswire",
    ...
    legalAdvisorSeller: null,
    country: "United States",
    assetScale: "Duffy BESS project in Matagorda County, Texas",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "DESRI (D. E. Shaw Renewable Investments) provides preferred equity financing for the Duffy BESS project developed by Linea Energy (EnCap Investments portfolio company)",
      "Project located in Matagorda County, Texas; debt financing was previously announced in December 2025",
      "Part of the growing trend of institutional capital flowing into standalone BESS projects in ERCOT to support Texas grid reliability",
    ],
  },
