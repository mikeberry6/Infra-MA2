...
export const deals: Deal[] = [
  ...
  {
    id: "INF-2026-061",
    title: "InfraVia acquires / DigitalBridge sells Substantial Group (Netomnia) for £2B",
    buyer: "InfraVia Capital Partners",
    seller: "DigitalBridge",
    sector: "Digital",
    subsector: "Fiber",
    region: "Europe",
    category: ["Acquisition (Majority Stake)", "Sale (Buyout)"],
    date: "2026-02-18T08:00:00Z",
    description:
      "DigitalBridge and its co-shareholders agreed to sell Substantial Group, the parent company of UK wholesale full-fibre operator Netomnia, to nexfibre for a £2 billion enterprise value. InfraVia Capital Partners, alongside Liberty Global and Telefónica (via their joint venture nexfibre), is the lead equity investor, directly committing £850 million of the £1 billion in new net equity funding.",
    targetDescription:
      "Substantial Group, the parent company of Netomnia, a UK wholesale full-fibre operator.",
    sourceName: "DigitalBridge / InfraVia Capital Partners",
    sourceUrl: "",
    enterpriseValue: "£2 billion",
    equityValue: "£850 million (InfraVia commitment of £1 billion total new equity)",
    stake: "100%",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    ...
    fundVehicle: null,
    keyHighlights: [
      "DigitalBridge fund and co-shareholders selling Substantial Group, parent of UK wholesale full-fibre operator Netomnia",
      "InfraVia committed £850 million of the £1 billion in new net equity funding as lead equity investor",
      "Acquisition conducted through nexfibre, a joint venture between Liberty Global, Telefónica, and InfraVia",
      "Transaction valued at £2 billion enterprise value",
    ],
  },
  // ─── 63. Macquarie Asset Management – IHS Towers LatAm ──────────
  {
    id: "INF-2026-063",
    title: "Macquarie Asset Management acquires IHS Towers Latin America operations",
    buyer: "Macquarie Asset Management",
    seller: "IHS Towers",
    sector: "Digital",
    subsector: "Telecom Towers",
    ...
    description:
      "Macquarie Asset Management agreed to acquire IHS Towers' Latin American operations (IHS Brazil and IHS Colombia) for an enterprise value of approximately $952 million. The carve-out buyout includes over 8,500 wireless tower sites in Brazil and 270 sites in Colombia.",
    targetDescription:
      "IHS Towers' Latin American operations, comprising IHS Brazil (~8,500 towers) and IHS Colombia (~270 towers).",
    sourceName: "Macquarie Asset Management",
    sourceUrl: "",
    enterpriseValue: "~$952 million",
    equityValue: null,
    stake: "100%",
    status: "Announced",
    closingDate: null,
    ...
    assetScale: "~8,770 wireless tower sites (8,500 in Brazil, 270 in Colombia)",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Carve-out acquisition of IHS Towers' Latin American operations including IHS Brazil and IHS Colombia",
      "Portfolio includes over 8,500 wireless tower sites in Brazil and approximately 270 sites in Colombia",
      "Enterprise value of approximately $952 million",
    ],
  },
  // ─── 64. TPG – Connected Infra Group Platform Launch ────────────
  {
    id: "INF-2026-064",
    title: "TPG launches Connected Infra Group with up to $1B equity for US telecom towers",
    buyer: "TPG",
    seller: "N/A (Platform Launch)",
    sector: "Digital",
    subsector: "Telecom Towers",
    ...
    date: "2026-02-17T08:00:00Z",
    description:
      "TPG, through its TPG Peppertree arm, announced a definitive agreement committing up to $1 billion in equity to launch Connected Infra Group, a new platform focused on acquiring and operating telecommunications real estate, primarily macro wireless towers in the US.",
    targetDescription:
      "Connected Infra Group, a new platform for acquiring and operating US telecommunications real estate, primarily macro wireless towers.",
    sourceName: "TPG",
    sourceUrl: "",
    enterpriseValue: null,
    equityValue: "Up to $1 billion",
    stake: "N/A",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    ...
    assetScale: null,
    valuationMultiple: null,
    fundVehicle: "TPG Peppertree",
    keyHighlights: [
      "TPG Peppertree committing up to $1 billion in equity to launch Connected Infra Group",
      "Platform focused on acquiring and operating telecommunications real estate, primarily macro wireless towers in the US",
    ],
  },
  // ─── 65. Allianz Global Investors – ATC Europe ──────────────────
  {
    id: "INF-2026-065",
    title: "Allianz Global Investors and Commerz Real acquire minority stake in ATC Europe",
    buyer: "Allianz Global Investors & Commerz Real",
    ...
    date: "2026-02-18T08:00:00Z",
    description:
      "Commerz Real and Allianz Global Investors (acting as fund manager) acquired a minority equity stake in telecom tower operator ATC Europe. The stake was sold by Allianz insurance companies.",
    targetDescription:
      "ATC Europe, a European telecom tower operator (subsidiary of American Tower Corporation).",
    ...
    fundVehicle: null,
    keyHighlights: [
      "Commerz Real and AllianzGI acquired a minority equity stake in ATC Europe, a telecom tower operator",
      "Stake sold by Allianz insurance companies to AllianzGI acting as fund manager",
    ],
  },
  // ─── 66. Basalt Infrastructure Partners – One Power ─────────────
  {
    id: "INF-2026-066",
    title: "Basalt Infrastructure Partners acquires One Power via OnSite Partners",
    ...
    description:
      "OnSite Partners (wholly owned by Basalt-advised funds) acquired the business interests of Ohio-based industrial power operator One Power, expanding the firm's distributed energy generation portfolio in the Midwest.",
    targetDescription:
      "One Power, an Ohio-based industrial power operator specializing in distributed energy generation.",
    sourceName: "Basalt Infrastructure Partners",
    sourceUrl: "",
    enterpriseValue: null,
    equityValue: null,
    stake: "100%",
    ...
    assetScale: null,
    valuationMultiple: null,
    fundVehicle: "Basalt-advised funds (via OnSite Partners)",
    keyHighlights: [
      "OnSite Partners (wholly owned by Basalt-advised funds) acquired One Power, an Ohio-based industrial power operator",
      "Expands Basalt's distributed energy generation portfolio in the Midwest",
    ],
  },
  // ─── 67. QIC – Kalfresh Energy Precinct ─────────────────────────
  {
    id: "INF-2026-067",
    title: "QIC and Wollemi Capital make A$80M climate investment in Kalfresh energy precinct",
    ...
    date: "2026-02-18T08:00:00Z",
    description:
      "QIC and Wollemi Capital made an A$80 million equity climate investment into Kalfresh to construct a 40-hectare integrated food and energy precinct featuring an anaerobic digestion bioenergy facility.",
    targetDescription:
      "Kalfresh, an Australian food producer constructing a 40-hectare integrated food and energy precinct with an anaerobic digestion bioenergy facility.",
    sourceName: "QIC",
    sourceUrl: "",
    enterpriseValue: null,
    equityValue: "A$80 million",
    stake: "Minority",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    ...
    legalAdvisorSeller: null,
    country: "Australia",
    assetScale: "40-hectare integrated food and energy precinct",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "A$80 million equity climate investment by QIC and Wollemi Capital into Kalfresh",
      "Funds to construct a 40-hectare integrated food and energy precinct with anaerobic digestion bioenergy facility",
    ],
  },
  // ─── 68. Blackstone – Fraport Greece ────────────────────────────
  {
    id: "INF-2026-068",
    title: "Blackstone acquires 10% stake in Fraport Greece from Marguerite Fund",
    buyer: "Blackstone",
    ...
    targetDescription:
      "Fraport Greece, holder of a 40-year concession to operate, maintain, and develop 14 regional airports across Greece.",
    sourceName: "Blackstone",
    sourceUrl: "",
    enterpriseValue: null,
    equityValue: "~€200 million (~$236.2 million)",
    stake: "10%",
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: null,
    ...
    valuationMultiple: null,
    fundVehicle: "Blackstone Infrastructure Strategies Fund",
    keyHighlights: [
      "Blackstone acquired a 10% minority equity stake in Fraport Greece via its Infrastructure Strategies Fund",
      "Transaction valued at approximately €200 million ($236.2 million)",
      "Fraport Greece operates 14 regional airports under a 40-year concession",
    ],
  },
  // ─── 69. Macquarie Asset Management – Qube Holdings Take-Private ──
  {
    id: "INF-2026-069",
    title: "Macquarie Asset Management-led consortium agrees to take-private Qube Holdings",
    buyer: "Macquarie Asset Management",
    seller: "Qube Holdings",
    sector: "Transportation",
    subsector: "Logistics & Ports",
    region: "Asia-Pacific",
    category: ["Acquisition (Buyout)"],
    date: "2026-02-16T08:00:00Z",
    description:
      "A Macquarie Asset Management-led consortium agreed to a take-private buyout of Qube Holdings Limited for an A$11.7 billion enterprise value. Qube's core assets include a supply chain network, rail terminals, bulk logistics facilities, and a 50% stake in Patrick Terminals.",
    targetDescription:
      "Qube Holdings Limited, an Australian logistics and ports company with a supply chain network, rail terminals, bulk logistics facilities, and a 50% stake in Patrick Terminals.",
    sourceName: "Macquarie Asset Management",
    sourceUrl: "",
    enterpriseValue: "A$11.7 billion",
    equityValue: null,
    stake: "100%",
    status: "Announced",
    closingDate: null,
    ...
    legalAdvisorSeller: null,
    country: "Australia",
    assetScale: "Supply chain network, rail terminals, bulk logistics facilities, 50% stake in Patrick Terminals",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "MAM-led consortium take-private buyout of Qube Holdings for A$11.7 billion enterprise value",
      "Qube's assets include supply chain network, rail terminals, bulk logistics facilities, and a 50% stake in Patrick Terminals",
    ],
  },
  // ─── 70. Schroders Greencoat – European BESS MoU ────────────
  {
    id: "INF-2026-070",
    title: "Schroders Greencoat signs MoU with CATL and Lochpine for 10 GWh European BESS development",
    buyer: "Schroders Greencoat",
    seller: "CATL / Lochpine Capital (JV/MoU)",
    sector: "Power & ET",
    ...
    legalAdvisorSeller: null,
    country: "United Kingdom",
    assetScale: "Up to 10 GWh BESS development pipeline across Europe",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
  ...
  {
    id: "INF-2026-071",
    title: "Vauban's Indigo Group acquires 100% of Central Parking System Colombia",
    buyer: "Vauban Infrastructure Partners (via Indigo Group)",
    seller: "Central Parking System Colombia",
    sector: "Transportation",
    subsector: "Parking",
    region: "Latin America",
    category: ["Acquisition (Buyout)"],
    date: "2026-02-02T08:00:00Z",
    description:
      "Indigo Park Colombia S.A.S., a subsidiary of Indigo Group (34.5% owned by Vauban Infrastructure Partners, 49.4% Crédit Agricole Assurances, 14.9% MEAG), acquired 100% of Central Parking System Colombia S.A.S., the third-largest parking operator in Colombia, becoming the market leader with 209 car parks across 25 cities.",
    targetDescription:
      "Central Parking System Colombia S.A.S., the third-largest parking operator in Colombia with 27 years of operations.",
    sourceName: "Indigo Group",
    ...
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: ["FGO Capital"],
    financialAdvisorSeller: null,
    legalAdvisorBuyer: ["Garrigues"],
    legalAdvisorSeller: null,
    country: "Colombia",
    assetScale: "209 car parks across 15 departments and 25 cities in Colombia; ~1,300 employees; 34% market share",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Indigo Group acquires 100% of Central Parking System Colombia (third-largest operator), becoming market leader with 209 car parks, 34% market share, and ~1,300 employees across 25 Colombian cities",
      "Third major Colombian acquisition in two years after City Parking (2024) and Hub 136 mobility PPP concession (2025); all operations rebranded under INDIGO brand",
      "Indigo Group manages 1.7 million parking spaces across 5,490 car parks in 10 countries; backed by Vauban Infrastructure Partners (34.5%), Crédit Agricole Assurances (49.4%), and MEAG (14.9%)",
    ],
  },
  // ─── 72. Fengate – BBGI (P3 Portfolio Sale) ─────────────────
  {
    id: "INF-2026-072",
    title: "Fengate agrees to sell Prince George's County Schools P3 and LAX ConRAC to BBGI",
    buyer: "BBGI Global Infrastructure",
    seller: "Fengate Asset Management",
    sector: "Social",
    subsector: "Public-Private Partnerships (P3)",
    region: "North America",
    category: ["Sale (Buyout)", "Acquisition (Buyout)"],
    date: "2026-02-03T08:00:00Z",
    description:
      "Fengate Asset Management entered exclusive negotiations to sell its stakes in two U.S. P3 assets — a 75% interest in the ~$1.24B Prince George's County (Maryland) Public Schools P3 (the first P3-delivered public school bundle in the U.S.) and 100% of the ~$2B LAX ConRAC facility — to BBGI Global Infrastructure (now owned by BCI).",
    targetDescription:
      "Prince George's County Schools P3 (~$1.24B, 30-year DBFOM for 6 schools) and LAX ConRAC (~$2B, 28-year DBFOM, 5.3-6.3M sq ft facility with 18,000+ parking stalls), both fully operational availability-based PPP concessions.",
    sourceName: "ION Analytics (Infralogic)",
    sourceUrl: "https://ionanalytics.com/insights/infralogic/fengate-negotiates-sale-of-school-conrac-p3s/",
    enterpriseValue: null,
    equityValue: null,
    stake: "75% (Schools) / 100% (ConRAC entity; 83.3% of LA Gateway Partners)",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    financialAdvisorSeller: null,
    ...
    legalAdvisorSeller: null,
    country: "United States",
    assetScale: "~$3.2B combined project value: 6 schools (MD) + LAX ConRAC (18,000+ stalls, 186 fueling stations)",
    valuationMultiple: null,
    fundVehicle: "Fengate Core Infrastructure III",
    keyHighlights: [
      "Prince George's County Schools: first U.S. P3-delivered public school bundle (~$1.24B, 30-year DBFOM, 6 schools all operational since May 2024, ~$400M savings vs. traditional procurement); Fengate 75% / Gilbane 25%",
      "LAX ConRAC: ~$2B, 28-year DBFOM, 5.3-6.3M sq ft with 18,000+ rental car stalls; availability payments from LAWA; Fengate holds 83.3% of LA Gateway Partners (PCL 16.7%)",
      "BBGI (taken private by BCI for C$1.9B in June 2025, 56 PPPs globally) is the buyer; Fengate conducted sale without financial advisor; assets from Core Infrastructure III (successor Fund IV closed at $1.1B in Jan 2025)",
    ],
  },
  // ─── 73. KKR – HMC Capital Energy Transition Partnership ───
  {
    id: "INF-2026-073",
    title: "KKR forms A$600M energy transition strategic partnership with HMC Capital",
    buyer: "KKR",
    seller: "HMC Capital",
    sector: "Power & ET",
    ...
    date: "2026-02-05T08:00:00Z",
    description:
      "KKR committed up to A$603 million (~US$417M) in seven-year preferred equity to HMC Capital's energy transition platform in Australia — A$355M upfront plus up to A$248M for the first BESS project. The platform includes 652 MW of operational assets (Victorian Big Battery, Bulgana Green Power Hub) and a 5.7 GW development pipeline.",
    targetDescription:
      "HMC Capital's energy transition platform with 652 MW operational assets (incl. 450 MWh Victorian Big Battery) and 5.7 GW BESS and wind development pipeline, chaired by former PM Julia Gillard.",
    sourceName: "KKR",
    ...
    enterpriseValue: null,
    equityValue: "Up to A$603 million (~US$417M)",
    stake: null,
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    ...
    legalAdvisorSeller: null,
    country: "Australia",
    assetScale: "652 MW operational (Victorian Big Battery, Bulgana Green Power Hub) + 5.7 GW BESS/wind pipeline",
    valuationMultiple: null,
    fundVehicle: "KKR Global Climate Transition Strategy",
    keyHighlights: [
      "Seven-year preferred equity: A$355M upfront + up to A$248M for first BESS project; KKR retains minority equity post-repayment; funded from KKR Global Climate Transition strategy (US$44B+ committed since 2010)",
      "Platform includes 652 MW operational assets (450 MWh Victorian Big Battery + 224 MW Bulgana Green Power Hub, acquired from Neoen for ~A$950M) and 5.7 GW BESS/wind pipeline; chaired by former PM Julia Gillard",
      "HMC Capital (~A$19B AUM) reduces invested capital to ~A$200M and receives A$5M annual corporate services fee; KKR's second Australian climate investment after CleanPeak (July 2025); expected closing mid-2026",
    ],
  },
  // ─── 74. KKR – SK Group (SK Eternix) Renewable Energy JV ────
  {
    id: "INF-2026-074",
    title: "KKR selected as preferred bidder for 50:50 renewable energy JV with SK Group consolidating SK Eternix",
    buyer: "KKR",
    seller: "SK Group (SK Discovery / SK Innovation E&S / SK Ecoplant)",
    sector: "Power & ET",
    subsector: "Renewable Energy",
    region: "Asia-Pacific",
    category: ["Joint Venture"],
    date: "2026-02-12T08:00:00Z",
    description:
      "SK Group's board selected KKR as the preferred bidder for a 50:50 renewable energy JV consolidating assets across SK Discovery (31% controlling stake in SK Eternix), SK Innovation E&S, and SK Ecoplant. SK contributes ~₩2.5T (~$1.3B) of power generation assets in kind; KKR contributes cash, for a combined JV value of ~₩5T (~$3.6B).",
    targetDescription:
      "SK Group's consolidated renewable energy business including SK Eternix (KRX: 475150, solar/wind/ESS/fuel cells), SK Innovation E&S renewables (3.2 GW solar + onshore wind), and SK Ecoplant renewables — positioned as Asia's largest renewable energy platform.",
    sourceName: "KED Global",
    sourceUrl: "https://www.kedglobal.com/energy/newsView/ked202602120008",
    enterpriseValue: "~₩5 trillion (~$3.6B combined JV value)",
    equityValue: "~₩2.5 trillion (~$1.3B SK asset contribution); KKR cash contribution TBD",
    stake: "50:50 JV",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    ...
    legalAdvisorSeller: null,
    country: "South Korea",
    assetScale: "3.2 GW+ solar, ~887 MW wind, ~800 MWh ESS, fuel cells, VPP operations across South Korea",
    valuationMultiple: null,
    fundVehicle: "KKR Global Climate Transition Strategy",
    keyHighlights: [
      "50:50 JV consolidating SK Group's renewable energy assets from three subsidiaries (SK Discovery, SK Innovation E&S, SK Ecoplant) to form Asia's largest renewable energy platform; SK Eternix shares rallied 18% on the news",
      "SK Eternix portfolio includes ~54 MW solar, ~887 MW wind, ~800 MWh ESS, and Korea's leading VPP operator; SK Innovation E&S adds 3.2 GW solar + onshore wind; consolidation eliminates overlapping projects across affiliates",
      "Builds on existing KKR-SK relationship (2021 ₩2.4T convertible preferred share investment in SK E&S); funded from KKR Global Climate Transition strategy (US$44B+ committed since 2010)",
    ],
  },
  // ─── 75. Tallvine Partners (Velocity FBO) – BTR Jet Center ──
  {
    id: "INF-2026-075",
    title: "Tallvine's Velocity FBO Network acquires BTR Jet Center in Baton Rouge",
    buyer: "Tallvine Partners (via Velocity FBO Network)",
    seller: "BTR Jet Center",
    sector: "Transportation",
    subsector: "Aviation Services (FBO)",
    region: "North America",
    category: ["Acquisition (Buyout)"],
    date: "2026-02-13T08:00:00Z",
    description:
      "Velocity FBO Network, a premier North American fixed-base operator platform backed by Tallvine Partners, acquired BTR Jet Center, the leading FBO at Baton Rouge Metropolitan Airport (KBTR) in Louisiana.",
    targetDescription:
      "BTR Jet Center, the leading fixed-base operator (FBO) at Baton Rouge Metropolitan Airport (KBTR), Louisiana.",
    ...
    legalAdvisorSeller: null,
    country: "United States",
    assetScale: "6,600 sq ft terminal, 90,000 sq ft hangar at Baton Rouge Metropolitan Airport",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Fifth location for Velocity FBO Network (backed by Tallvine Partners), joining airports in Detroit, Orlando, Georgia, and Arizona",
      "BTR Jet Center features a 6,600 sq ft two-story terminal and 90,000 sq ft hangar accommodating ultra-long-range business jets, opened in 2021",
  ...
  // ─── 76. Infratil – Contact Energy Equity Raise ─────────────
  {
    ...
    date: "2026-02-16T08:00:00Z",
    description:
      "Contact Energy announced a NZ$525 million equity raise (NZ$450M placement + NZ$75M retail offer) to fund renewable energy projects, which Infratil officially supported by taking up its pro rata share. Infratil previously acquired an initial stake in Contact Energy in October 2025.",
    targetDescription:
      "Contact Energy Limited, a New Zealand integrated energy company and gentailer with 97% renewable generation.",
    ...
    enterpriseValue: null,
    equityValue: "NZ$525 million (total equity raise)",
    stake: null,
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: null,
    ...
    legalAdvisorSeller: null,
    country: "New Zealand",
    assetScale: "NZ's largest listed energy company; 97% renewable generation",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Contact Energy raised NZ$525M (NZ$450M fully underwritten placement at NZ$8.75/share + NZ$75M retail offer) to fund Glenbrook Battery 2.0 (300 MW, ~NZ$235M), Glorit Solar Farm (50/50 JV with Lightsource bp, ~NZ$305M total), and Tauhara 2 geothermal pre-FID drilling (~NZ$30M)",
      "Infratil took up its pro rata share, having acquired ~14% of Contact Energy through the October 2025 TECT stake purchase and Manawa Energy integration",
      "Contact reported H1 FY26 net profit up 44% to NZ$205M with 97% renewable generation; equity raise reduces net debt/EBITDA from 2.8x to 2.3x",
    ],
  },
  // ─── 77. APG Asset Management – Utility Global Series D ─────
  {
    ...
    sector: "Power & ET",
    subsector: "Clean Hydrogen / Industrial Decarbonization",
    region: "North America",
    category: ["Acquisition (Minority Stake)"],
    date: "2026-02-17T08:00:00Z",
    description:
    ...
    enterpriseValue: null,
    equityValue: "$100 million (Series D first close)",
    stake: null,
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: null,
  ...
  {
    id: "INF-2026-078",
    title: "DESRI provides preferred equity financing for EnCap-backed Linea Energy's Duffy BESS in Texas",
    buyer: "DESRI",
    seller: "Linea Energy (EnCap Investments)",
    sector: "Power & ET",
    subsector: "Battery Storage",
    region: "North America",
    category: ["Acquisition (Minority Stake)"],
    date: "2026-02-18T08:00:00Z",
    description:
      "DESRI (D. E. Shaw Renewable Investments, 80+ projects / 12+ GW portfolio) announced the signing of a preferred equity investment in Linea Energy's Duffy BESS project — a 235 MW AC / 470 MWh standalone battery storage facility in Matagorda County, Texas, with expected COD in December 2027.",
    targetDescription:
      "Duffy BESS, a 235 MW AC / 470 MWh (2-hour) standalone battery storage project in Matagorda County, Texas, developed by Linea Energy (an EnCap Energy Transition portfolio company).",
    sourceName: "PR Newswire",
    ...
    financialAdvisorBuyer: null,
    financialAdvisorSeller: null,
    legalAdvisorBuyer: ["King & Spalding"],
    legalAdvisorSeller: ["Orrick, Herrington & Sutcliffe"],
    country: "United States",
    assetScale: "235 MW AC / 470 MWh (2-hour) standalone BESS; future 500 MW Duffy Solar co-location planned",
    valuationMultiple: null,
    fundVehicle: "EnCap Energy Transition Fund II",
    keyHighlights: [
      "DESRI (80+ projects, 12+ GW portfolio) provides preferred equity for Linea Energy's 235 MW / 470 MWh Duffy BESS; project debt financing closed December 2025 with Nord/LB (CLA), Societe Generale and SMBC (JLAs)",
      "Standalone BESS under construction in Matagorda County, TX (ERCOT) with expected COD December 2027; Linea has also identified a 500 MW Duffy Solar co-location opportunity",
      "EnCap Investments (~$40B raised across 24 funds) backs Linea Energy via its Energy Transition platform; DESRI signaled interest in expanding the capital partnership with Linea",
    ],
  },
  // ─── 79. ADIA – CleanMax Enviro IPO Anchor ──────────────────
  {
    id: "INF-2026-079",
    title: "ADIA anchors CleanMax Enviro Energy Solutions' ₹31B IPO alongside Temasek",
    buyer: "Abu Dhabi Investment Authority (ADIA)",
    seller: "CleanMax Enviro Energy Solutions (IPO)",
    sector: "Power & ET",
    subsector: "Renewable Energy (C&I Solar)",
    region: "Asia-Pacific",
    category: ["Acquisition (Minority Stake)"],
    ...
    description:
      "Abu Dhabi Investment Authority (ADIA), via Zulia Investments, participated as an anchor investor in the ₹3,100 crore (~$341M) IPO of CleanMax Enviro Energy Solutions, India's largest commercial and industrial renewable energy provider. ADIA received ~6.31 lakh shares at ₹1,053/share (~₹66.5 crore) as part of a total anchor round of ₹921 crore (~$101M).",
    targetDescription:
      "CleanMax Enviro Energy Solutions Limited, India's largest C&I renewable energy provider with 2.80 GW operational and 5.97 GW contracted capacity, backed by Brookfield (31.42% pre-IPO).",
    sourceName: "Bloomberg",
    sourceUrl: "https://www.bloomberg.com/news/articles/2026-02-20/temasek-adia-said-to-plan-investing-in-clean-max-s-india-ipo",
    enterpriseValue: null,
    equityValue: "~₹66.5 crore (~$7.3M ADIA allocation); ₹921 crore (~$101M total anchor round)",
    stake: null,
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: null,
    ...
    legalAdvisorSeller: null,
    country: "India",
    assetScale: "2.80 GW operational, 5.97 GW contracted; 43.5% of capacity directed to data centre and AI customers",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "ADIA (via Zulia Investments) and Temasek among anchor investors in ₹921 crore (~$101M) anchor round at ₹1,053/share; total IPO of ₹3,100 crore (~$341M) downsized from originally planned ₹5,200 crore",
      "CleanMax has 2.80 GW operational and 5.97 GW contracted capacity with ~23-year average PPA tenor; 43.5% of capacity serves data centre and AI customers including Apple, Google, and Equinix",
      "Distinct from Temasek's earlier ~₹760 crore pre-IPO investment (Feb 12); Brookfield (BGTF) held 31.42% pre-IPO, declining to ~21% post-IPO; IPO opened February 23, listing March 2",
    ],
  },
];
