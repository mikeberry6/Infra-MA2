...
export const deals: Deal[] = [
  ...
  // ─── 72. Fengate – BBGI (P3 Portfolio Sale) ─────────────────
  {
    ...
    date: "2026-02-03T08:00:00Z",
    description:
      "Fengate Asset Management entered exclusive negotiations to sell its stakes in two P3 assets — a 75% interest in the Prince George's County (Maryland) Public Schools P3 and 100% of the LAX Consolidated Rent-A-Car Facility (ConRAC) — to BBGI Global Infrastructure.",
    targetDescription:
      "Prince George's County Schools P3 (six schools DBFOM) and LAX ConRAC (consolidated rent-a-car facility), both PPP concessions in the United States.",
    ...
    legalAdvisorSeller: null,
    country: "United States",
    assetScale: "Six public schools (Prince George's County, MD) and LAX ConRAC facility",
    valuationMultiple: null,
    fundVehicle: "Fengate Core Infrastructure III",
    keyHighlights: [
      "Fengate selling 75% stake in Prince George's County Schools P3 (six schools DBFOM, financial close December 2020) and 100% of LAX ConRAC (financial close December 2018)",
      "BBGI Global Infrastructure (taken private by BCI in June 2025) is the buyer; BBGI owns 56 PPPs across the US, Europe, and Canada",
      "Both assets are from Fengate Core Infrastructure III fund; Fengate did not use a third-party financial advisor",
    ],
  },
