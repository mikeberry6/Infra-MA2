...
export const deals: Deal[] = [
  ...
  // ─── 79. ADIA – CleanMax Enviro IPO Anchor ──────────────────
  {
    ...
    description:
      "Abu Dhabi Investment Authority (ADIA) participated as a cornerstone/anchor investor in the IPO of CleanMax Enviro Energy Solutions, India's largest commercial and industrial renewable energy provider. ADIA and Temasek together anchored the ~₹31 billion (~$341M) offering.",
    targetDescription:
      "CleanMax Enviro Energy Solutions Limited, India's largest commercial and industrial (C&I) renewable energy provider, backed by Brookfield.",
    ...
    enterpriseValue: null,
    equityValue: "~₹31 billion (~$341M total IPO)",
    stake: null,
    status: "Closed",
    closingDate: "February 2026",
    financialAdvisorBuyer: null,
    ...
    fundVehicle: null,
    keyHighlights: [
      "ADIA and Temasek anchored ~₹9.3B (~$102M) of shares in the CleanMax Enviro IPO at ₹1,053/share (top of price band), alongside domestic mutual funds and insurers",
      "CleanMax IPO comprises ₹1,200 crore fresh issue and ₹1,900 crore offer-for-sale by promoter Kuldeep Jain and BGTF One Holdings (Brookfield); IPO opened February 23",
      "Distinct from Temasek's earlier ~₹760 crore pre-IPO investment (February 12); ADIA's anchor allocation confirmed February 20 ahead of IPO launch",
    ],
  },
];
