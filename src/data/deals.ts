...
export const deals: Deal[] = [
  ...
  // ─── 61. DigitalBridge – Substantial Group (Netomnia) Sale ────────
  {
    id: "INF-2026-061",
    title: "DigitalBridge sells Substantial Group (Netomnia parent) to nexfibre consortium",
    buyer: "nexfibre",
    seller: "DigitalBridge",
    sector: "Digital",
    subsector: "Fiber",
    ...
    description:
      "DigitalBridge and its co-shareholders agreed to sell Substantial Group, the parent company of UK wholesale full-fibre operator Netomnia, to nexfibre for a £2 billion enterprise value.",
    targetDescription:
    ...
    keyHighlights: [
      ...
      "Buyer nexfibre is a joint venture between Liberty Global, Telefónica, and InfraVia Capital Partners",
      "Transaction valued at £2 billion enterprise value",
    ],
  },
  // ─── 62. InfraVia Capital Partners – Substantial Group Acquisition ──
  {
    id: "INF-2026-062",
    title: "InfraVia Capital Partners commits £850M to acquire Substantial Group via nexfibre",
    ...
    date: "2026-02-18T08:00:00Z",
    description:
      "InfraVia Capital Partners, alongside Liberty Global and Telefónica (via their joint venture nexfibre), agreed to acquire Substantial Group for a £2 billion enterprise value. InfraVia directly committed £850 million of the £1 billion in new net equity funding.",
    targetDescription:
      "Substantial Group, the parent company of Netomnia, a UK wholesale full-fibre operator.",
    sourceName: "InfraVia Capital Partners",
    sourceUrl: "",
    ...
    stake: "Majority (via nexfibre consortium)",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    financialAdvisorSeller: null,
    ...
    fundVehicle: null,
    keyHighlights: [
      "InfraVia committed £850 million of the £1 billion in new net equity funding for the acquisition",
      "Acquisition conducted through nexfibre, a joint venture with Liberty Global and Telefónica",
      "Transaction valued at £2 billion enterprise value for Substantial Group (parent of Netomnia)",
    ],
  },
