...
export const deals: Deal[] = [
  ...
  // ─── 45. InfraRed Capital Partners – Brazos Wind & Madison Fields ─
  {
    id: "INF-2026-045",
    title: "InfraRed Capital Partners acquires stakes in Brazos Wind and Madison Fields from Shell",
    buyer: "InfraRed Capital Partners",
    seller: "Shell",
    sector: "Power & ET",
    subsector: "Renewable Energy (Wind & Solar)",
    region: "North America",
    ...
    targetDescription:
      "Brazos Wind, a 182 MW onshore wind farm, and Madison Fields, a 180 MW solar facility, both located in the United States.",
    sourceName: "InfraRed Capital Partners",
    sourceUrl: "https://www.ircp.com/news/",
    enterpriseValue: null,
    equityValue: null,
    stake: "60% (Brazos Wind) / 50% (Madison Fields)",
    status: "Announced",
    closingDate: null,
    financialAdvisorBuyer: null,
    financialAdvisorSeller: null,
    ...
    legalAdvisorSeller: null,
    country: "United States",
    assetScale: "362 MW combined (182 MW wind + 180 MW solar)",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Acquired a 60% interest in Brazos Wind (182 MW onshore wind) and a 50% interest in Madison Fields (180 MW solar) from Shell",
      "Combined 362 MW of contracted renewable generation capacity across wind and solar technologies",
      "Shell retains minority stakes in both assets, maintaining a joint venture structure for ongoing operations",
    ],
  },
  // ─── 46. InfraBridge & Equitix – Truespeed ─────────────
  {
    id: "INF-2026-046",
