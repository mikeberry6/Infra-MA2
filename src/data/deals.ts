...
export const deals: Deal[] = [
  ...
  // ─── 71. Vauban (Indigo Group) – Central Parking Colombia ───
  {
    ...
    date: "2026-02-02T08:00:00Z",
    description:
      "Indigo Park Colombia S.A.S., a subsidiary of Indigo Group (backed by Vauban Infrastructure Partners), acquired 100% of Central Parking System Colombia S.A.S., the second-largest parking operator in Colombia.",
    targetDescription:
      "Central Parking System Colombia S.A.S., the second-largest parking operator in Colombia.",
    ...
    legalAdvisorSeller: null,
    country: "Colombia",
    assetScale: "Second-largest parking operator in Colombia",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "Indigo Group (backed by Vauban Infrastructure Partners and Crédit Agricole Assurances) acquires 100% of Central Parking System Colombia, the country's second-largest parking operator",
      "Consolidates Indigo's position as the leading parking operator in Colombia, expanding its Latin American footprint",
      "Vauban Infrastructure Partners is the infrastructure arm of Natixis Investment Managers",
    ],
  },
