...
export const deals: Deal[] = [
  ...
  // ─── 73. KKR – HMC Capital Energy Transition Partnership ───
  {
    ...
    date: "2026-02-05T08:00:00Z",
    description:
      "KKR formed a A$600 million strategic partnership with HMC Capital to invest in energy transition infrastructure in Australia, including renewable energy, battery storage, and grid-scale assets.",
    targetDescription:
      "HMC Capital's energy transition platform targeting renewable energy, battery storage, and grid-scale infrastructure in Australia.",
    sourceName: "KKR",
    ...
    legalAdvisorSeller: null,
    country: "Australia",
    assetScale: "A$600M energy transition platform (renewables, battery storage, grid-scale)",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "KKR commits A$600 million in preferred equity to HMC Capital's energy transition platform in Australia",
      "Partnership targets renewable energy, battery storage, and grid-scale infrastructure assets",
      "Builds on KKR's global infrastructure strategy and HMC Capital's Australian energy transition expertise",
    ],
  },
