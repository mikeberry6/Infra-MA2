...
export const deals: Deal[] = [
  ...
  // ─── 74. KKR – SK Group (SK Eternix) Data Center JV ─────────
  {
    id: "INF-2026-074",
    title: "KKR selected as preferred bidder for SK Eternix data center JV with SK Group",
    buyer: "KKR",
    seller: "SK Group",
    sector: "Digital",
    subsector: "Data Centers",
    ...
    date: "2026-02-12T08:00:00Z",
    description:
      "SK Group's board officially notified KKR of its selection as the preferred bidder and joint venture partner for SK Eternix, SK Group's data center subsidiary. The partnership involves KKR acquiring a stake in SK Eternix to co-develop data center infrastructure in South Korea.",
    targetDescription:
      "SK Eternix, SK Group's data center subsidiary and platform in South Korea.",
    ...
    legalAdvisorSeller: null,
    country: "South Korea",
    assetScale: "SK Eternix data center platform in South Korea",
    valuationMultiple: null,
    fundVehicle: null,
    keyHighlights: [
      "SK Group's board selected KKR as the preferred bidder and JV partner for SK Eternix, the conglomerate's data center subsidiary",
      "Deal reflects strong global infrastructure investor demand for Asian data center platforms driven by AI and cloud computing growth",
      "KKR continues to expand its digital infrastructure portfolio in Asia-Pacific alongside existing data center investments",
    ],
  },
