...
Return exactly one minified fenced `json` object, then `Result recorded.` Nothing else. Keep it under 6,000 characters, use no more than 8 evidence rows and 4 milestones, and keep strings concise. Every top-level key below is mandatory:
