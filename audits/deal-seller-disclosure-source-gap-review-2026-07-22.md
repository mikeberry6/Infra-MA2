...
- Washington State Department of Ecology PARIS records for [Recovery 1](https://apps.ecology.wa.gov/paris/FacilitySummary.aspx?FacilityId=75272691) (permit `WAR001386`) and [Tacoma Yard DTG](https://apps.ecology.wa.gov/paris/FacilitySummary.aspx?FacilityId=96403) (permit `WAR307170`) each list a March 24, 2026 `Full Transfer` coverage letter. Both facility records subsequently list April 24 submissions labeled `WasteConnections`, after March 13 submissions labeled `DTGRecycle`.
- Those government records are partial primary regulatory corroboration for permit-coverage transfers and subsequent Waste Connections activity at two named Pierce County facilities. They do not establish a purchase agreement, price, February transaction date, Macquarie exit, founder repurchase, or the complete transferred-asset perimeter.
